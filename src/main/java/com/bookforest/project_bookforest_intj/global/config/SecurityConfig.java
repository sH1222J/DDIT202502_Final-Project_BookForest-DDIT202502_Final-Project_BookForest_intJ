        ...
        */
        ...
        http.csrf(csrf->csrf.disable()).httpBasic(hbasic->hbasic.disable())
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/css/**", "/js/**", "/images/**", "/favicon.ico", "/user/register", "/user/login", "/user/find-id", "/user/forgot-password", "/user/reset-password", "/user/forgot-password-confirmation","/user/change-password","/**").permitAll()
